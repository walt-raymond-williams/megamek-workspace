...
1. `BoardView` redraw scheduling and repaint coalescing.
2. `BoardView` sprite and hex drawing paths, especially large visible boards and isometric mode.
3. Minimap redraw behavior during large battles.
4. Princess path enumeration and ranking, including expensive per-entity loops.
5. ECM/FOV calculations and repeated full-entity scans during board redraw or selection changes.
