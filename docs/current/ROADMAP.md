...
- Open questions: Is built-in/manual entry sufficient for the first real campaign once user task `#23` creates a realistic campaign? Which exact live UI checks should issue `#13` preserve?
