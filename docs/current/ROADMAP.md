...
- Handoff notes: Preserve the current MegaMek campaign/source investigation strength while making the generic pattern obvious to outsiders.
- Dependencies: None.
...
- Handoff notes: Follow `CAMPAIGN_ANALYSIS_WORKFLOW.md`. Do not overwrite the save.
- Dependencies: None.
...
- Handoff notes: Use `rg "cpnx"` and related source searches from `KNOWN_COMMANDS.md`.
...
- Handoff notes: Resume from `docs/current/HELP_FILE_USAGE_GUIDANCE_STATE.md`.
