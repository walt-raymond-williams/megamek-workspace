...
Status: jar-backed read-only prototype for GitHub issue `#29`, created `2026-06-21`.
...
- `Needs MekHQ inspection`: full contract term extraction is generic for `Mission` fields in this prototype; richer `Contract` subclass terms should be added in a future source-owned exporter.
